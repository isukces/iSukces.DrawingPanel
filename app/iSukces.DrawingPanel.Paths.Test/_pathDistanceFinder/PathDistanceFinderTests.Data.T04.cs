...
namespace iSukces.DrawingPanel.Paths.Test
{
    public partial class PathDistanceFinderTests
    {
        private static IEnumerable<PathDistanceFinderTestData> Data_04()
        {
            ...
            yield return new PathDistanceFinderTestData(64.279316892978613, 6.7199534219792536, 5.5826389658121434,
                Three.Inside, 1)
            {
            ...
            yield return new PathDistanceFinderTestData(62.112017976824205, 6.658122442358346, 4.2240359536484062,
                Three.Below, 1)
            {
            ...
            yield return new PathDistanceFinderTestData(60.781597292910043, 7.4326585175431337, 4.5010394201153137,
                Three.Above)
            {
                ClosestPoint       = new Point(60, 3),
                Direction          = new Vector(1, 0),
            ...
            yield return new PathDistanceFinderTestData(61.417646973811777, -1.1171457620483798, 2.5422639048627991,
                Three.Inside, 1)
            {
            ...
            yield return new PathDistanceFinderTestData(70.9519395225704, -6.7334624907536087, 5.3175032771482584,
                Three.Inside, 1)
            {
            ...
            yield return new PathDistanceFinderTestData(71.602532907491721, 3.9448828975262318, 5.3779227090385033,
                Three.Inside, 1)
            {
            ...
            yield return new PathDistanceFinderTestData(91.668194870773576, 14.970977750386224, 2.2446123358070085,
                Three.Above, 1)
            {
                ...
                Track              = 56.339835132046687,
                ElementTrackOffset = 50
            };
            yield return new PathDistanceFinderTestData(88.7609856464017, 15.34082005680526, 2.3605961599203824,
                Three.Above, 1)
            {
                ClosestPoint       = new Point(90.08101426698947, 13.383797146602106),
                Direction          = new Vector(0.19611613513818402, 0.98058067569092011),
                SideMovement       = -1.6781983262332261,
                Track              = 56.132344713652259,
                ElementTrackOffset = 50
            };
            yield return new PathDistanceFinderTestData(87.55127664651198, 11.803041639193705, 2.042425182585196,
                Three.Inside, 1)
            {
            ...
            yield return new PathDistanceFinderTestData(91.3871634786231, 11.293521463145076, 1.7704634069883776,
                Three.Inside, 1)
            {
