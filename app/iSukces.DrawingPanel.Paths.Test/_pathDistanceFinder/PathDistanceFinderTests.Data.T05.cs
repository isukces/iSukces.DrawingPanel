...
namespace iSukces.DrawingPanel.Paths.Test
{
    public partial class PathDistanceFinderTests
    {
        private static IEnumerable<PathDistanceFinderTestData> Data_05()
        {
            ...
            yield return new PathDistanceFinderTestData(63.533168016697374, -0.071336099391488883, 4.6143669106560061, Three.Inside, 1)
            {
            ...
            yield return new PathDistanceFinderTestData(61.796889054745073, 8.2185447387672639, 3.3199536846918809, Three.Inside, 1)
            {
            ...
            yield return new PathDistanceFinderTestData(61.031475972751807, -2.30648385799719, 5.4058036976520913, Three.Above)
            {
            ...
            yield return new PathDistanceFinderTestData(62.622467274295545, -1.3645184777457642, 5.0917930189016234, Three.Below, 1)
            {
                ClosestPoint       = new Point(60, 3),
            ...
            yield return new PathDistanceFinderTestData(73.322291655870487, 12.856375201353783, 5.45390363492448, Three.Inside, 1)
            {
            ...
            yield return new PathDistanceFinderTestData(73.438551524022046, 1.980595655394481, 5.3790240580809545, Three.Inside, 1)
            {
            ...
            yield return new PathDistanceFinderTestData(91.879262337271385, -12.754062464905578, 1.5174089295963855, Three.Inside, 1)
            {
            ...
            yield return new PathDistanceFinderTestData(88.890882345643533, -12.916518322167533, 1.4398257278009898, Three.Inside, 1)
            {
            ...
            yield return new PathDistanceFinderTestData(88.194539524101486, -15.888646134283963, 2.2754996942707746, Three.Above, 1)
            {
                ...
                Track              = 47.287971682626413,
                ElementTrackOffset = 50
            };
            yield return new PathDistanceFinderTestData(91.303202664928847, -16.428171668351929, 2.1856293067269092, Three.Above, 1)
            {
                ClosestPoint       = new Point(90.08101426698947, -14.616202853397894),
                Direction          = new Vector(-0.19611613513818402, -0.98058067569092011),
                SideMovement       = -1.5538106460526979,
                Track              = 47.207360994749692,
                ElementTrackOffset = 50
            };
