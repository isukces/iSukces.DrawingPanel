...
namespace iSukces.DrawingPanel.Paths.Test
{
    public class TwoReferencePointsPathCalculatorTests
    {
        ...
        public void T01_Should_create_simple()
        {
            ...
            AssertEx.Equal(-20, 0, 2.11145618000168, 11.0557280900008, (LinePathElement)r.Arcs[0], 6);
            ...
            AssertEx.Equal(40, 20, 60, 20, (LinePathElement)r.Arcs[2], 6);
        ...
        public void T02_Should_create_left_too_close()
        {
            ...
            AssertEx.Equal(23.02022, 21.05943, 60, 20, (LinePathElement)r.Arcs[2], 6);
            tmp1 = (ArcDefinition)r.Arcs[3];
            Assert.Equal(ArcDirection.Clockwise, tmp1.Direction);
    ...
    [Fact]
        public void T03_Should_create_left_little_out()
        {
            ...
            AssertEx.Equal(-6, 20, 60, 20, (LinePathElement)r.Arcs[2], 6);
            tmp1 = (ArcDefinition)r.Arcs[3];
            Assert.Equal(ArcDirection.Clockwise, tmp1.Direction);
            Assert.Equal(45, tmp1.Angle, 6);
            AssertEx.Equal(60, -28.2842712474619, tmp1.Center);
        ...
        public void T04_Should_create_big_rotation_angle()
        {
            ...
            AssertEx.Equal(52.23347, -12.60536, 17.4, 13.16829, (LinePathElement)r.Arcs[2], 6);
            tmp1 = (ArcDefinition)r.Arcs[3];
            Assert.Equal(ArcDirection.Clockwise, tmp1.Direction);
